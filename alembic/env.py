...
from src.tg_bot.database.base import Base
from src.tg_bot.database.predictions.models import Prediction
from src.tg_bot.database.profile.models import Profile
from src.tg_bot.database.user.models import User
...
# Generate revision: alembic revision --autogenerate -m 'revision name'
